...
<div class="homeNavBar">
	<div class="w clearfix" style="z-index: 2;">
		...
		<ul class="fr clearfix navitems-2016">
			...
			<li class="fl"><a
				href="http://localhost:8762/service-user/index.jsp">首页</a></li>
			<li class="fl"><a
				href="http://localhost:8762/service-user/index.jsp">最新促销</a>
			</li>
		</ul>
	</div>
</div>
	...
	<div class="productDetaLeft fl">
		<div class="secondTypeList">
			...
			<c:forEach items="${first.secondType }" var="second">
				...
				<dl>
					 <c:if test="${second.secondtype_name ==secondType.secondtype_name}">
					 <dt data="true">
					  	<i></i>${second.secondtype_name }
	...
	<div class="productDetaRight fr">
		...
		<div class="chooseCondition">
			<dl class="clearfix class-type">
				<dt class="fl">类型</dt>
				<dd class="fl">
					<a href="javascript:;" class="all_cate active" data-id="1">全部</a>
					<c:forEach items="${secondType.thirdType}" var="third">
					 	<a href="javascript:;" class="data_curent" data-current-id="65" data-id="65">${third.thirdtype_name}</a>
					 </c:forEach>
				</dd>
			</dl>
		 <c:forEach items="${allAttr}" var="attribute">
			<dl class="clearfix class-brand">
				<dt class="fl">${attribute.attribute_name}</dt>
				<dd class="fl f2">
				<a href="javascript:;" class="all_cate active" data-id="1">全部</a>
